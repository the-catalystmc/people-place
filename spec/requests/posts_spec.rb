...
RSpec.describe 'Posts', type: :request do
  describe 'GET /users/index/posts' do
    ...
    it "If the response body includes correct placeholder text." do
      expect(response.body).to include('Here is a list of available posts on People\'s Place.')
    end
    ...
    describe 'GET /users/index/post/id' do
      ...
      it "If the response body includes correct placeholder text." do
        expect(response.body).to include('Here is a list of available comments on a given post.')
      end
      it "If a correct template was rendered." do
