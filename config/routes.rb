Rails.application.routes.draw do
  ...
  delete "/users/:id/posts/:post_id", to: "posts#destroy", as: "destroy_post"
  delete "/users/:id/posts/:post_id/comments/:comment_id", to: "comments#destroy", as: "destroy_comments"
